...
class VisualsSettingsSubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		var option:Option = new Option('Intro Video:',
			"What style do you want for The Intro?\n(NOTE: you need to restart the game to apply these changes.)",
			'introvideoCutscene',
			STRING,
			['Normal', 'Alternate', 'WinXP', 'WinVista B1', 'Mario World', 'Disabled']);
		addOption(option);
		...
		var option:Option = new Option('Developer Mode',
			"THIS IS FOR TESTING PURPOSES ONLY\nIF YOU ARE NOT IN THE DEV PROGRAM, REPORT IT!",
			'devMode',
			BOOL);
		addOption(option);
		#end
