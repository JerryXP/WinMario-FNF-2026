...
class ResultState extends MusicBeatSubState
{
  ...
  public function new(params:ResultsStateParams)
  {
    ...
    bgFlash = FlxGradient.createGradientFlxSprite(FlxG.width, FlxG.height, [0xFFFFA6F1, 0xFFFFBEF1], 90);
  ...
  override function create():Void
  {
    ...
    var bg:FlxSprite = FlxGradient.createGradientFlxSprite(FlxG.width, FlxG.height, [0xFFFE5CCD, 0xFFFD5CBF], 90);
    bg.scrollFactor.set();
    bg.zIndex = 10;
    bg.cameras = [cameraBG];
    add(bg);
    ...
    var tallyMarvelous:TallyCounter = new TallyCounter(250 + MobileScaleMode.gameNotchSize.x, (hStuf * 4) + extraYOffset, params.scoreData.marvelous, 0xFF89C9F8);
    ratingGrp.add(tallyMarvelous);
    
    var tallySick:TallyCounter = new TallyCounter(230 + MobileScaleMode.gameNotchSize.x, (hStuf * 5) + extraYOffset, params.scoreData.sick, 0xFF89C9E5);
    ratingGrp.add(tallySick);

    var tallyGood:TallyCounter = new TallyCounter(210+ MobileScaleMode.gameNotchSize.x, (hStuf * 6) + extraYOffset, params.scoreData.good, 0xFF89E59E);
